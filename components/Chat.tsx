    ...
    <div className={styles.game}>
      ...
      <NameDescription
        ...
        nameDescriptions={[
          ...
          { name: "mom", description: "is very strict and mean" },
          {
            name: "god",
            description:
              "is supreme being, creator, and principal object of faith",
          },
          { name: "gpt-j", description: "is very nice and funny" },
          {
            name: "obama",
            description:
              "is an American politician, lawyer, and author who served as the 44th president of the United States",
          },
          {
            name: "trump",
            description:
              "is an American politician, media personality, and businessman who served as the 45th president of the United States",
          },
          {
            name: "the devil",
            description:
              "is the personification of evil as it is conceived in various cultures and religious traditions",
          },
          {
            name: "the president",
            description:
              "is a very prominent figure in the country and nice to the people that support it",
          },
          {
            name: "the scientist",
            description:
              "is a person who conducts scientific research to advance knowledge in an area of interest",
          },
          {
            name: "the physicist",
            description:
              "is a scientist who specializes in the field of physics, which encompasses the interactions of matter and energy at all length and time scales in the physical universe",
          },
          {
            name: "the mathematician",
            description:
              "This is a chat between a ${your_name} and ${ai_name}. ${ai_name} is someone who uses an extensive knowledge of mathematics in their work, typically to solve mathematical problems",
          },
        ]}
      />
